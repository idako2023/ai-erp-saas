      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            人工智能赋能跨境电商：真正的智能助手，解放您的电商管理
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              无需操作复杂流程，不用学习使用教程，
              通过语言指令，轻松完成电商运营任务，
              全方位智能化管理，助您提升运营效率和利润
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="https://github.com/idako2023/nextjs-chat"
                target="_blank"
                rel="noopener"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            已支持 <span className="text-indigo-600">2+主流</span>{" "}
            跨境电商平台
          </div>

          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="text-gray-400 dark:text-gray-400">
              <Image src={amazonLogo} alt="Amazon Logo" width={200} height={200} />
            </div>
            <div className="text-gray-400 dark:text-gray-400">
              <Image src={verizonLogo} alt="Verizon Logo" width={200} height={200} />
            </div>
            <div className="text-gray-400 dark:text-gray-400">
              <Image
                src={microsoftLogo}
